...
<head>
    ...
    <!-- CANONICAL -->
    <link rel="canonical" href="https://www.jazzeventual.com/jazz-events.php">

    <!-- COMMON-LOCALIZATION -->
    <?php include "common-php/localization/jazz-corporate.html"; ?>
    <!-- COMMON-LOCALIZATION END -->

    <!-- SITE INFORMATION -->
    <title>Jazz Eventos de Empresa | Grupo de Jazz para eventos corporativos</title>
    <meta name="description" content="Grupo de Jazz para eventos corporativos, música en directo para eventos de empresa. Jazz Eventual en formato Solista, Duo o Trío.">
    <meta name="keywords" content="jazz, eventos, corporativo, empresa, música, solista, duo, trio">
...
<body class="page">
    ...
    <div class="page-header">
        <div class="container text-center">
            <h1 class="page-title">Jazz para eventos</h1>
            <ol class="breadcrumb">
                <li>Grupo de jazz para eventosprivados y eventos de empresa. Música en directo para eventos corporativos.</li>
            </ol>
        </div>
    </div>
    <!-- PAGE HEADER END -->
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 col-xs-12">
                        <div class="text-center">
                            <h3 class="section-title" id="events-cocktail">Música para Eventos Cocktail</h3>
    	...
    	<div class="section section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 col-xs-12">
                        <div class="text-center">
                            <h3 class="section-title" id="events-ambience">Jazz de ambiente y amenización</h3>
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="section-header left-style">
                                <h3 class="section-title">Música<br/>& vídeos</h3>
                            </div>
                        </div>
                        <div class="col-sm-7">
                            <div class="purchase-button-wrap">
                                <a class="btn btn-border btn-white" href="https://www.instagram.com/oldmoneymakers/" target="_blank" rel="noopener" title="instagram SAXONARA"><i class="fa-brands fa-instagram"></i> Instagram</a>
        ...
        <div class="section section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 col-xs-12">
                        <div class="text-center">
                            <h3 class="section-title" id="events-dinner">La Música perfecta para cenas</h3>
